...
$pageTitle = isset($title) ? $title : 'CyberVision';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="cv-navbar">
    <a href="index.php" class="cv-navbar-brand">
        <?php if ($logoExists): ?>
            <img src="<?= $logoSrc ?>" alt="CyberVision Logo">
        <?php endif; ?>
        CyberVision
    </a>
    ...
    <div class="cv-navbar-menu" id="cvNavMenu">
        <ul class="cv-navbar-nav">
            ...
            <li><a href="credits.php" class="<?= (isset($currentPage) && $currentPage == 'credits') ? 'active' : '' ?>" <?= (isset($currentPage) && $currentPage == 'credits') ? 'aria-current="page"' : '' ?>>Credits</a></li>
        </ul>
        ...
        <div class="cv-navbar-actions">
            ...
            <?php if (isset($_SESSION['islogged']) && isset($_SESSION['role']) && $_SESSION['role'] == 'admin'): ?>
