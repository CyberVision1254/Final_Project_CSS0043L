...
<div style="max-width:760px;margin:0 auto;padding:48px 40px 80px;">
    ...
    <div class="text-center mb-4">
        <i class="bi bi-check-circle-fill" style="font-size:3.5rem;color:var(--cv-accent);"></i>
    ...
    <div class="cv-table-wrap mb-4">
        <table class="cv-table">
            ...
            <tbody>
                <?php if ($items_result): while ($item = mysqli_fetch_assoc($items_result)): ?>
                    <tr>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <p class="fw-bold mb-0" style="color:var(--cv-accent);font-size:1.1rem;">
